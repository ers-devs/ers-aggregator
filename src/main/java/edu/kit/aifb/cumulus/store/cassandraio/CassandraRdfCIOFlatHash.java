...
public class CassandraRdfCIOFlatHash extends CassandraRdfCIOQuads {
	...
	public CassandraRdfCIOFlatHash(String hosts) {
		this(hosts, DEFAULT_KS);
	}

	public CassandraRdfCIOFlatHash(String hosts, String keyspace) {
