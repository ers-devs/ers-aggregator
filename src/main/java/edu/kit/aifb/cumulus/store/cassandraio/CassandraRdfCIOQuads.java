...
public class CassandraRdfCIOQuads extends AbstractCassandraRdfCIO {
	...
	public CassandraRdfCIOQuads(String hosts) {
		this(hosts, DEFAULT_KS);
	}
	
	public CassandraRdfCIOQuads(String hosts, String keyspace) {
